...
#import "UIViewController+ATGuid.h"
...
@interface SWGuidViewCell : UICollectionViewCell

@property (nonatomic, copy) NSString* imageName;
@property (nonatomic, strong) UIImageView* imageView;
@end
@implementation SWGuidViewCell
...
/************************以上是SWGuidViewCell,以下才是UIViewController+KSGuid******************************/

@implementation UIViewController (ATGuid)
#pragma mark-
...
- (UIButton*)removeBtn{
    ...
    [removeBtn setTitle:@"进入主页" forState:UIControlStateNormal];
...
- (void)setupSubViews{
    ...
    [collectionView registerClass:[SWGuidViewCell class] forCellWithReuseIdentifier:@"SWGuidViewCell"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    SWGuidViewCell* cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"SWGuidViewCell" forIndexPath:indexPath];
