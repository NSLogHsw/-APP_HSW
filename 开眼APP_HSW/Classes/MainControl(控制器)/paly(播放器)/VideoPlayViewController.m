...
- (void)viewDidLoad {
    ...
    _playerLayer.frame = CGRectMake(0, 0, SCREENH, SCREENW);
    _shadeView.frame = CGRectMake(0, 0, SCREENH, SCREENW);
...
-(void)setUpControllView{
    ...
    _player.volume = 2;
    _ControlView.frame = CGRectMake(0, 0, SCREENH, SCREENW);
    ...
    _pauseButton.frame = CGRectMake(SCREENH/2-22, SCREENW/2-22, 44, 44);
