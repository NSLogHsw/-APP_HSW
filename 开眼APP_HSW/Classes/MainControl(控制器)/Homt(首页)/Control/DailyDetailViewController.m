...
-(void)setUI{
    ...
    [backImageView sd_setImageWithURL:[NSURL URLWithString:self.model.coverForDetail] completed:nil];
    ...
    [imageView sd_setImageWithURL:[NSURL URLWithString:self.model.coverForDetail] completed:nil];
    [self.view addSubview:imageView];
    
    UIImageView *playImage = [[UIImageView alloc]initWithFrame:CGRectMake(SCREENW/2 - 35, SCREENW/2 - 35, 70, 70)];
    playImage.image = [UIImage imageNamed:@"play"];
    [self.view addSubview:playImage];
    
    UILabel *titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(10, imageView.bottom + 10, SCREENW - 20, 20)];
    ...
    UILabel *messageLabel = [[UILabel alloc]initWithFrame:CGRectMake(10, titleLabel.bottom + 10, SCREENW - 20, 20)];
    ...
    UIButton *Linebtn = [[UIButton alloc]initWithFrame:CGRectMake(10, messageLabel.bottom + 10, SCREENW - 10, 1)];
    [Linebtn setBackgroundColor:[UIColor grayColor]];
    Linebtn.userInteractionEnabled = NO;
    [self.view addSubview:Linebtn];
    
    // Desc
    UILabel *desLabel = [[UILabel alloc]initWithFrame:CGRectMake(10, Linebtn.bottom + 10, SCREENW - 20, 100)];
    desLabel.text = self.model.description;
    ...
    // 设置Desc行间距
    NSMutableAttributedString * attributedString1 = [[NSMutableAttributedString alloc] initWithString:self.model.description];
    NSMutableParagraphStyle * paragraphStyle1 = [[NSMutableParagraphStyle alloc] init];
    [paragraphStyle1 setLineSpacing:6];
    [attributedString1 addAttribute:NSParagraphStyleAttributeName value:paragraphStyle1 range:NSMakeRange(0, [self.model.description length])];
    [desLabel setAttributedText:attributedString1];
    [desLabel sizeToFit];
    
    [self.view addSubview:desLabel];
    
    UIButton *btn = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, SCREENW, SCREENW)];
    ...
    for (int i = 0; i < 4; i ++) {
        ...
        image.frame = CGRectMake(SCREENW/5 * i + 10, SCREENH - 48, 15, 15);
        Btn.frame = CGRectMake(SCREENW/5 * i + 25, SCREENH - 50, 45, 20);
        image.image = arr[i];
...
-(void)btnClicked{
    ...
    videoPlay.titleStr = self.model.title;
